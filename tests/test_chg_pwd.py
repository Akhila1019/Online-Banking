...
driver.find_element_by_name("old").send_keys("Akhila123")  #id/name
time.sleep(1)
driver.find_element_by_name("new1").send_keys("Amrita123")  #id/name 
time.sleep(1)
driver.find_element_by_name("new2").send_keys("Amrita123")  #id/name
time.sleep(1)
